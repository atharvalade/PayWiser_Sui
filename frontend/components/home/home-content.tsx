    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-96px)] w-full">
      <div className="z-10 w-full max-w-3xl px-5 xl:px-0 text-center transform -translate-y-8">
        ...
        <p 
          ...
          `}
        >
          Powered by Sui blockchain, Wormhole cross-chain protocol, Walrus decentralized storage, Seal privacy technology, and Nautilus infrastructure - delivering secure, seamless biometric payments.
        </p>
