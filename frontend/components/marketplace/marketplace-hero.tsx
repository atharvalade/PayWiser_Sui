    ...
    <div className="relative w-full flex flex-col items-center overflow-hidden pt-28 pb-20 md:pt-32 md:pb-28">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute bottom-[10%] left-1/3 w-[40%] h-[40%] rounded-full bg-blue-300/20 blur-[90px]"
        />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 max-w-6xl text-center">
        ...
        >
          Verification <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 font-extrabold">Marketplace</span>
        </motion.h1>
        ...
        >
          <motion.button 
            ...
            whileTap={{ scale: 0.98 }}
            className="rounded-full bg-indigo-600 px-8 py-4 text-white font-medium transition-all duration-300 shadow-lg"
          >
            Verify Content
          </motion.button>
          <motion.button 
